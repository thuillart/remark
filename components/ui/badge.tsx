...
const badgeVariants = cva(
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-md font-medium text-xs ring ring-inset transition-[color,box-shadow] focus-visible:ring-3 focus-visible:ring-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3",
  {
    variants: {
      variant: {
        default:
