    ...
    <section className="container">
      <div className="py-24">
        ...
        <div className="mt-12 grid gap-x-10 gap-y-12 md:grid-cols-2">
          <div className="relative flex h-82 flex-col-reverse overflow-hidden rounded-2xl border p-4 md:h-94 md:p-8">
          ...
          <div className="relative flex h-82 flex-col gap-4 overflow-hidden rounded-2xl border p-4 md:h-94 md:p-8">
            <h5 className="self-start text-lg/6 font-medium -tracking-[.015em] [&_span]:opacity-50">
              Tiny by design.{" "}
            ...
            <div className="from-background absolute inset-0 -z-1 bg-gradient-to-t to-transparent" />
            <div className="-z-2 -mr-8 -mb-8 h-full rounded-tl-xl border-t border-l shadow-md"></div>
          </div>
        </div>
      </div>
    </section>
