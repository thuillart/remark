        ...
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-[1fr_2fr] md:gap-18">
          ...
          <div className="space-y-8">
            ...
            <Link
              ...
              className="text-muted-foreground hover:text-foreground relative flex w-fit items-center gap-1 bg-gradient-to-b from-current to-current bg-[length:0_100%] bg-[position:0_1.4em] bg-no-repeat pb-2 text-base leading-none font-medium no-underline transition-[background-size] duration-200 ease-in-out before:absolute before:bottom-0 before:h-0.5 before:w-full before:bg-[linear-gradient(90deg,currentColor,currentColor_33.33%,transparent_0,transparent_66.66%,currentColor_0,currentColor)] before:bg-[length:300%_2px] before:bg-[position:right_0_bottom_0] before:bg-no-repeat before:opacity-40 before:transition-[background-position,opacity] before:duration-200 before:content-[''] hover:bg-[length:100%_100%] hover:delay-200 hover:before:bg-[position:right_50%_bottom_0] hover:before:opacity-100 hover:before:delay-0"
            >
              Contact us
